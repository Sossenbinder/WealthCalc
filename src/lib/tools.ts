...
export const tools: Tool[] = [
  ...
  {
    slug: "fire-rechner",
    related: ["zinseszins-rechner", "entnahmeplan-rechner", "etf-sparplan-nach-steuern"],
    category: "geldanlage",
    title: "FIRE-Rechner: Welche Stufe hast du erreicht?",
    navTitle: "FIRE-Rechner",
    description:
      "Berechne, wo du auf dem Weg zur finanziellen Freiheit stehst — Coast, Barista, Lean, FIRE oder Fat — mit dem Kapitalbedarf jeder Stufe, deinem Fortschritt und dem Alter, in dem du sie mit deiner Sparrate erreichst.",
    keywords: [
      "FIRE Rechner",
      "Coast FIRE",
      "Barista FIRE",
  ...
  },
  {
    ...
    related: ["fire-rechner", "zinseszins-rechner", "rendite-rechner"],
    category: "geldanlage",
